...
const decorator = (Component, keyHandler) => class KeyButton extends React.Component<any, any> {
  componentWillMount() {
...
export const triggerKey = 
    (key?: string) => 
    <T extends Object>(Component: React.ComponentClass<T> | React.StatelessComponent<T>): React.StatelessComponent<T & TriggerKeyProps> => {
